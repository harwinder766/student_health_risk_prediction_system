...
st.set_page_config('Prediction Module')
...
with col1:
    st.subheader("Sleep")
    sleep_duration =float(st.number_input("Sleep Duration",min_value=3.0,max_value= 10.0))
...
with col2:
    ...
    exercise_duration = float(st.number_input('Exercise Duration', min_value=0.0, max_value=100.0))
    water_intake = float(st.number_input('Water Intake', min_value=0.5, max_value=4.5))
